...
Point(1) = {2500, 2500, -500, cl_1};
Point(2) = {2500, 2500, 500, cl_1};
Point(3) = {-2500, 2500, 500, cl_1};
Point(4) = {-2500, 2500, -500, cl_1};
Point(5) = {-2500, -2500, -500, cl_1};
Point(6) = {-2500, -2500, 500, cl_1};
Point(7) = {2500, -2500, 500, cl_1};
Point(8) = {2500, -2500, -500, cl_1};
